        ...
        <div className="min-h-screen">
            <div className='shadow py-4'>
                <div className='px-5 flex justify-between items-center'>
                    <img width={200} onClick={e => navigate('/')} className='max-sm:w-30 cursor-pointer' src={assets.logo} alt="" />
                    {companyToken && (
                        <div className='flex items-center gap-3'>
                            <p className='max-sm:hidden '>Welcome {companyData?.name || 'Company'}</p>
                            <div className='relative group'>
                                <img className='w-8 border rounded-full ' src={companyData?.image || assets.profile_img} alt="company" />
            ...
            <div className="flex items-start">
                {/* Left side bar with add, manage  jobs and application */}
